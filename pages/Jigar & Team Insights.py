...
PASSWORD_HASH = hash_password("teamjigar")
CREDENTIALS = {
    "jigar": PASSWORD_HASH,
    "admin": PASSWORD_HASH,
...
# ---------------------------
st.set_page_config(page_title="Jigar & Team Insights", layout="wide")
st.title("📊 Jigar & Team Detailed Insights")
